...
These don't either and they should be avoided for now.
...
One thing to remember is that the home directory is always that of the `master.Rmd` document. Therefore, it is necessary to establish the path to the img file from there. Here is the code used to produce the above figure:
